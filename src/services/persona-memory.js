...
async function updateMemory(userId, persona, conversationHistory) {
  ...
  try {
    ...
    var instructions = [
      'You are maintaining a memory note about a person based on their conversation.',
      ...
      'Keep it concise (under 200 words), factual, third-person, bullet-style. Do NOT include small talk or details about the other speaker.',
      '',
