...
function buildDeliveryInstructions(text, personaAlias) {
  var ACCENTS = {"Luna":"Speak with a distinct European Portuguese accent, like a native Portuguese person from Lisbon speaking English. Do not use an American accent.","Kai":"Speak with a clear New Zealand accent, like a native New Zealander. Do not use an American accent.","Amara":"Speak with a distinct Kenyan accent, like a native Kenyan speaking English. Do not use an American accent.","Marco":"Speak with a clear Argentine (Buenos Aires) Spanish accent speaking English. Do not use an American accent.","Yuki":"Speak with a distinct Japanese accent, like a native Japanese person speaking English. Do not use an American accent.","Zara":"Speak with a clear British London English accent. Do not use an American accent.","Rio":"Speak with a distinct Brazilian Portuguese accent speaking English. Do not use an American accent.","Naia":"Speak with a natural American accent.","Jade":"Speak with a distinct Korean accent, like a native Korean speaking English. Do not use an American accent.","Theo":"Speak with a clear Manchester / Northern English accent. Do not use an American accent.","Aisha":"Speak with a Gulf Arabic (Emirati) accent speaking English. Do not use an American accent.","Felix":"Speak with a distinct German accent, like a native German speaking English. Do not use an American accent.","Maya":"Speak with a natural American accent.","Oscar":"Speak with a distinct Mexican Spanish accent speaking English. Do not use an American accent.","Leila":"Speak with a distinct French accent, like a native French person speaking English. Do not use an American accent.","Priya":"Speak with a clear Indian English accent, like a native Indian speaking English. Do not use an American accent.","Dex":"Speak with a Canadian accent.","Elena":"Speak with a distinct Spanish (Andalusian) accent speaking English. Do not use an American accent.","Sam":"Speak with a distinct Nigerian accent, like a native Nigerian speaking English. Do not use an American accent.","River":"Speak with a distinct Swedish accent, like a native Swede speaking English. Do not use an American accent."};
